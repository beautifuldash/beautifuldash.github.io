class Main {
    ...
    setModalInfo(id, lvlname, verifer, author, length, rate, url, points, progress_points, progress) {
        ...
        const authorText = 'Verified by ' + verifer + '. Created by ' + author; 
        ...
        information.appendChild(this.infoItem('Level Length:', length + ' sec'));
        information.appendChild(this.infoItem('Rate:', rate));
        information.appendChild(this.infoItem('Points:', points));

        if(progress_points && progress) {
            information.appendChild(this.infoItem('Progress points:', progress_points + '/' + progress + '%'));
        }
    }
